  ...
  public static void main(String[] args) {
    ...
    String query =
        "SELECT name, SUM(number) as total"
            ...
            + "  WHERE name = 'William'"
            + "  GROUP BY name;";
    authUserQuery( scopes, query);
  }

  public static void authUserQuery(
       List<String> selectedScopes, String query) {
    // Reading credentials file
    try (InputStream inputStream = AuthUserQuery.class.getClassLoader().getResourceAsStream("testMy.json")) {
