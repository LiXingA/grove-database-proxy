...
public class AddColumnLoadAppend {
  ...
  public static void addColumnLoadAppend(
      String datasetName, String tableName, String sourceUri, Schema newSchema) throws IOException {
    try {
      // Initialize client that will be used to send requests. This client only needs
      // to be created
      // once, and can be reused for multiple requests.
      String projectId = "red-shape-384801";
      ...
      try (InputStream serviceAccountStream = Main.class.getClassLoader().getResourceAsStream("testMy.json")) {
      ...
      LoadJobConfiguration loadJobConfig = LoadJobConfiguration.builder(tableId, sourceUri)
